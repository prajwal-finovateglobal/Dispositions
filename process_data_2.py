...
df = pd.read_csv('/Users/apple/Downloads/test_dispo.csv')
df['chat'] = df['transcript'].apply(lambda x: json.loads(x))
df['contact_to'] = "9876543210"
df['duration'] = 100
df['direction'] = 'outbound'
df['recording'] = 'https://www.youtube.com/watch?v=dQw4w9WgXcQ'
df['uid'] = '1234567890'
